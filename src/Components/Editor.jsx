 ...
 <iframe
  ...
  {Html?(
    <div className='flex w-full bg-[#181515] m-0 px-9 gap-10 cursor-default'>
     <div className='bg-[#1e1e1e] p-3 px-10 rounded-t-xl' onClick={() => setHtml(true)}>HTML</div>
     <div className='hover:bg-[#1e1e1e] p-3 px-10 rounded-t-xl' onClick={() => setHtml(false)}>CSS</div>
     </div>
  ):(
    <div className='flex w-full bg-[#181515] m-0 px-9 gap-10 cursor-default'>
    <div className='hover:bg-[#1e1e1e] p-3 px-10 rounded-t-xl' onClick={() => setHtml(true)}>HTML</div>
    <div className='bg-[#1e1e1e] p-3 px-10 rounded-t-xl' onClick={() => setHtml(false)}>CSS</div>
    </div>
  )}

<div>
  {Html?(
    <Editor height="74.5vh" language="html" value={htmlCode} theme="vs-dark" 
 options={{
  fontSize: "16px",
...
onChange={(value) => setHtmlCode(value)}
  />
    ...
    <Editor height="74.5vh" language="css" value={cssCode} theme="vs-dark" 
 options={{
  fontSize: "16px",
  autoClosingBrackets: true,
  minimap: { enabled: false },
